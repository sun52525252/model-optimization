...
DefaultQuantizeRegistry = default_quantize_registry.DefaultQuantizeRegistry
...
class QuantizeWrapperTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def setUp(self):
    ...
    self.quantize_registry = DefaultQuantizeRegistry()
  ...
  def testSerializationQuantizeWrapper(self):
    ...
    custom_objects.update(default_quantize_registry._types_dict())
